...
for batch in range(20):
    ...
    for i in range(start_index, end_index):
        ...
        # Use masked predictions to overlay on original image
        axes[i - start_index, 1].imshow(test_images[i])
        axes[i - start_index, 1].imshow(masked_preds[i].squeeze(), alpha=0.5, cmap='jet') 
